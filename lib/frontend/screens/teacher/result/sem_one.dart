...
class Sem1ResultPage extends StatefulWidget {
  ...
  @override
  State<Sem1ResultPage> createState() => _Sem1ResultPageState();
}

class _Sem1ResultPageState extends State<Sem1ResultPage> {
...
Future<void> _submitResult() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Sem1 Result - ${widget.subject.subjectName}"),
        centerTitle: true,
